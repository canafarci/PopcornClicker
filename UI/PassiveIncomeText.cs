...
public class PassiveIncomeText : MonoBehaviour
{
    ...
    public void UpdateText(float moneyPerSpawn, int popcornPerClick, float speed, int spawnerCount)
    {


        _moneyPerSecond = ((moneyPerSpawn * popcornPerClick * speed) + (moneyPerSpawn * spawnerCount * speed)) / 2f * 1.134512f;
        SetText();
    }
